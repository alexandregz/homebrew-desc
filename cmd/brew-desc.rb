...
descriptions = {
  ...
  "avfs" => "Virtual file system that allows programs to look inside archives",
  ...
  "awsenv" => "Local credential management for multiple AWS accounts",
  ...
  "ext2fuse" => "Compact implementation of the ext2 file system using FUSE",
  ...
  "pla" => "Tool for building gantt charts in format PNG, EPS, PDF or SVG",
  ...
  "rofs-filtered" => "Filtered read-only filesystem for FUSE",
  ...
  "simple-mtpfs" => "MTP fuse filesystem driver",
